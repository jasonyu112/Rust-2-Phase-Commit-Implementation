...
impl Client {
    ...
    pub fn new(id_str: String,
               running: Arc<AtomicBool>, tx: Sender<message::ProtocolMessage>, rx: Receiver<message::ProtocolMessage>) -> Client {
        Client {
            id_str: id_str,
            running: running,
            num_requests: 0,
    ...
    pub fn protocol(&mut self, n_requests: u32) {
        ...
        while requests_sent < n_requests && self.running.load(Ordering::SeqCst) {
